 ...
 *
 */
public class IncomingStatementsProvider implements IStatementsProvider {
	 ...
	 * Конструктор
	 */
	public IncomingStatementsProvider(HolidayCalculatorModelProvider aHolidayModelProvider) {
	...
	public Collection<Statement<?>> getStatements() {
		...
		return model.getIncomingStatements();
	}
