...
/**
 * Входные данные редактора {@link MakeRecallEditor}
 */
public class MakeRecallEditorInput implements IEditorInput {
	 ...
	 * Конструктор
	 */
	public MakeRecallEditorInput(HolidayCalculatorModelProvider aModelProvider) {
