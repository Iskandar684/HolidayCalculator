...
public class IncomingStatementsEditor extends EditorPart {
    ...
    public void createPartControl(Composite aParent) {
        ...
        StatementsTableCreator creator =
                new StatementsTableCreator(new IncomingStatementsProvider(_holidayModelProvider));
    ...
    private static class StatementProvider implements IStatementProvider {
        ...
        private final CopyOnWriteArrayList<IStatementChangedListener> _listeners =
